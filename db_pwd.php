...
$DB_USERNAME = "smiller_web"; //Your userid for tophat/database server, this is case sensitive
$DB_DATABASE = "smiller_demo"; //Name of your database, the default is yourusername_default, this is case sensitive
